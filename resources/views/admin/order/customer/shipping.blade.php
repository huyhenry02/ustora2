                    ...
                    <div class="col-md-12">
                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li>
                                    <a href="{{route('order_by_customer.confirmed')}}">Confirmed Orders
                                ...
                                <li class="btn btn-secondary">
                                    ...
                                    <button type="button" class="btn btn-secondary"><a href="{{route('order_by_customer.shipping')}}">Shipping Orders</a>
                                        <span class="product-count">{{$countShippingOrders}}</span></button>
                                </li>
